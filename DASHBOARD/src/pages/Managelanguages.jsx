...
const Managelanguages = () => {
  const { loading, languages, error, message } = useSelector(
  ...
  const handleUpdateLanguage = (id) => {
    dispatch(updateLanguage(id, newProficiency))
  }
  ...
  useEffect(() => {
    if (error) {
      toast.error(error)
      dispatch(clearAllLanguagesErrors())
    }

    if (message) {
      toast.success(message)
      dispatch(resetLanguageSlice())
  ...
  return (
    <>
      <div className="relative min-h-screen overflow-hidden bg-[#020617] px-4 py-10 lg:px-8">
        ...
        <Tabs defaultValue="languages" className="relative z-10">
                ...
                <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
                  ...
                  <div>
                    ...
                    <p className="mt-4 max-w-2xl text-base leading-relaxed text-gray-400">
                      Manage, update, and showcase your technical languages with
                ...
                {languages && languages.length > 0 ? (
                              ...
                              <TooltipProvider>
                                <Tooltip>
                                  ...
                                  <TooltipTrigger asChild>
                                    ...
                                    <button
                                      onClick={() =>
                                        handleDeleteLanguage(element._id)
                                      }
                            ...
                            <CardFooter className="mt-8 flex-col items-start gap-4 p-0">
                              ...
                              <div className="w-full">
                                ...
                                <Input
                                  ...
                                  onBlur={() =>
                                    handleUpdateLanguage(element._id)
                                  }
                              ...
                              <p className="text-xs leading-relaxed text-gray-500">
                                Update the Language proficiency percentage from
                                0 to 100.
                              </p>
                            </CardFooter>
                          </div>
                  ...
                  <div className="flex min-h-137.5 flex-col items-center justify-center rounded-[2.5rem] border border-dashed border-white/10 bg-white/5 px-6 text-center backdrop-blur-2xl">
                    ...
                    <p className="mt-5 max-w-2xl text-lg leading-relaxed text-gray-400">
                      You have not added any Languages yet. Add your technologies,
