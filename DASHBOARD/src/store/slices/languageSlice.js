...
export const getAllLanguages = () => async(dispatch) => {
    ...
    try {
        const {data} = await axios.get("https://my-portfolio-bckend.onrender.com/api/v1/language/getall",{withCredentials:true});
...
export const addNewLanguage = (formData) => async(dispatch) => {
    ...
    try {
        const {data} = await axios.post(`https://my-portfolio-bckend.onrender.com/api/v1/language/add`, formData, {withCredentials:true, headers:{'Content-Type':'multipart/form-data'}});
...
export const deleteLanguage = (id) => async(dispatch) => {
    ...
    try {
        const {data} = await axios.delete(`https://my-portfolio-bckend.onrender.com/api/v1/language/delete/${id}`,{withCredentials:true});
...
export const updateLanguage = (id, proficiency) => async(dispatch) => {
    ...
    try {
        const {data} = await axios.put(`https://my-portfolio-bckend.onrender.com/api/v1/language/update/${id}`, {proficiency}, {withCredentials:true, headers:{'Content-Type':'application/json'}});
