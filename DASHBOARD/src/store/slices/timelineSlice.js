...
export const getAllTimelines = () => async(dispatch) => {
    ...
    try {
        const {data} = await axios.get("https://my-portfolio-bckend.onrender.com/api/v1/timeline/getall",{withCredentials:true});
...
export const addNewTimeline = (formData) => async(dispatch) => {
    ...
    try {
        const {data} = await axios.post(`https://my-portfolio-bckend.onrender.com/api/v1/timeline/add`, formData, {withCredentials:true, headers:{'Content-Type':'application/json'}});
...
export const deleteTimeline = (id) => async(dispatch) => {
    ...
    try {
        const {data} = await axios.delete(`https://my-portfolio-bckend.onrender.com/api/v1/timeline/delete/${id}`,{withCredentials:true});
